import 'package:ecomm_app/features/setting/application/setting_service.dart';
import 'package:ecomm_app/features/setting/application/setting_service_impl.dart';
import 'package:ecomm_app/features/setting/presentation/state/setting_state.dart';
...
class SettingController extends StateNotifier<SettingState> {
  ...
  void addPassCodeToBox(String key, String? value) async {
    final result = await _settingService.addToBox(key, value);
    if (result) {
